...
WORD aMsgOSD[6] = {3, CHAR_O, CHAR_S, CHAR_D};
...
WORD aMsgRear[6] = {4, CHAR_R, CHAR_e, CHAR_a, CHAR_r};
...
WORD aMENURepeatAll[5] = {3, CHAR_A, CHAR_l, CHAR_l};
...
WORD aBUTTONNo[3] = {2, CHAR_N, CHAR_o};
...
WORD aMMSaveDlgContent[6] = {5, CHAR_S, CHAR_a, CHAR_v, CHAR_e, CHAR_QUESTION_MARK};
